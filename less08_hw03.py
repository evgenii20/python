...
print("Программа проверки списка на наличие только чисел")

list = []
while True:
    try:
        num = int(input('Введите число или введите "00" для выхода: '))
        if num == 00:
            print(f'Список чисел {list}. Выход.')
            break
        elif num < 0:
    ...
    #     print("На ноль делить нельзя")
        ...
        print(f"Все хорошо. Ваш список: {list} ")
